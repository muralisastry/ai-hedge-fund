"""Financial Datasets (FD) provider.

This is the original ``src/tools/api.py`` logic moved verbatim (including the
in-memory cache usage and 429 backoff). It remains the fallback provider and
the parity baseline until every data type has been migrated and validated.
"""
...
class FinancialDatasetsProvider:
    """Provider backed by https://api.financialdatasets.ai."""
